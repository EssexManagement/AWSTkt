...
export const ACCT_PROD     = "acct-prod"
export const ACCT_NONPROD  = "acct-nonprod"
...
export const DefaultITSupportEmailAddress = "nci-cancer-trials-finder-awsadmins@mail.nih.gov"  //// Can be a single/simple-string (one-email) or a LIST of email-addresses
