...
import { DeleteStacksInSequence } from '../lib/deleteStacksInSequence-stack';
import { DeleteStacksInParallel } from '../lib/deleteStacksInParallel-stack';
...
let STACKNAME = "StepFn-DeleteStacksInSequence"
// STACKNAME = `${constants.CDK_APP_NAME}-${constants.CDK_OPERATIONS_COMPONENT_NAME}-${tier}-${STACKNAME}`
// STACKNAME = `${constants.CDK_APP_NAME}-devops-${tier}-${STACKNAME}`  // better way is shown in next line below.
// STACKNAME = constants.get_FULL_AWS_RESOURCE_PREFIX(tier, git_branch, STACKNAME, "devops" ) //// overriding constants.CDK_OPERATIONS_COMPONENT_NAME as "devops"
console.log(`STACKNAME='${STACKNAME}'`)

//// ------------------------------------------------------------
/// CDK app begins here.
let stk1 = new DeleteStacksInSequence(app, STACKNAME,
    tier,
    aws_env,
    git_branch,
    {
...
STACKNAME = "StepFn-DeleteStacksInParallel"
// STACKNAME = `${constants.CDK_APP_NAME}-${constants.CDK_OPERATIONS_COMPONENT_NAME}-${tier}-${STACKNAME}`
// STACKNAME = `${constants.CDK_APP_NAME}-devops-${tier}-${STACKNAME}`  // better way is shown in next line below.
// STACKNAME = constants.get_FULL_AWS_RESOURCE_PREFIX(tier, git_branch, STACKNAME, "devops" ) //// overriding constants.CDK_OPERATIONS_COMPONENT_NAME as "devops"
console.log(`STACKNAME='${STACKNAME}'`)
...
//// ------------------------------------------------------------
/// CDK app begins here.
const stk2 = new DeleteStacksInParallel(app, STACKNAME,
    tier,
    aws_env,
    git_branch,
    {
...
stks.forEach( stk => {
    ...
    stk.tags.setTag("component",   constants.CDK_OPERATIONS_COMPONENT_NAME);
