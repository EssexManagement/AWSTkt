...
class Identify_CodeBuildIamRoles_usedByDevOpsPipeline(GenericAWSCLIScript):
    ...
    def run(self):
        ...
        base_pattern = f"{constants.CDK_APP_NAME}-{component_regexp}-pipe?l?i?n?e?-{partial_tiername}-{constants.CDK_APP_NAME}{component_regexp}{self.tier}ApplnC?D?K?S?-{uuid_regexp}"
